  				...
  				<p>薪酬管理&gt;&gt;薪酬标准管理&gt;&gt;标准登记</p>
  					<form action="" method="post" id="_from">
  						<table  style="line-height:70px;margin-left:20px;" >
  							...
  							<input id="textearea" class="easyui-textbox" label="审核意见：" labelwidth="100"  labelPosition="left" style="width:86%;height:120px;" type="text" name="dengjiren"  />
  					...
  					<div style="margin:140px auto 0 300px ">
						...
						<a href="#" class="easyui-linkbutton c8" style="width:100px">审核通过</a>
						<a href="#" class="easyui-linkbutton c8" style="width:100px">驳回</a>
