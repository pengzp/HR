    ...
    <div id="tb_box" style="width: 900px;height: 800px;margin:20px auto">
        ...
        <table width="100%">
            <form method="post" id="upfrom" action="">
                <tr>
                    <td>所属部门：</td>
                    <td><select class=textbox id=sChannel2 style="WIDTH: 160px;HEIGHT:22px" maxLength=50 name="dept_id">
                            <option value="1">财务部</option>
                            <option value="2" selected>人事部</option>
                            <option value="3">研发部</option>
                            <option value="4">安保部</option>
                            <option value="5">法务部</option>
                ...
                <tr>
                    <td>职位名称：</td>
                    <td><select class=textbox id=sChannel2 style="WIDTH: 160px;HEIGHT:22px" maxLength=50 name="job_id">
                            <option value="1">职工</option>
                            <option value="2" selected>主管</option>
